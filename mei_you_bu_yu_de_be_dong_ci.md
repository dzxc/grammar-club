...
介绍完两种补语的句型，最后把be动词的用法做个补充。<b>be 动词是最纯粹的** linking verb **，**解释为“ 是 ”**，后面应该要有 补语 才算完整。**如果看到be动词后面没有补语**，表示这个 be 动词**并不是当做连缀动词**使用。**这时候 be 动词并不解释为“是”，而要解释为“存在”**，用在最单纯的**“主语+动词(S+V)"的句型中**。</b>

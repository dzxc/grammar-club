...
虽然从初中开始就教五种基本句型，可是其中有两种（{% em color="#df8f8f" %}句型3：主语+动词+补语（S+V+C）{% endem %} 和 （{% em color="#df8f8f" %}句型5：主语+动词+宾语+补语(S+V+O+C){% endem %})关于**补语**的句型，许多人恐怕一直没有真正搞清楚是怎么回事。如果有五分之二的简单句没有弄懂，接下来的复句可就没办法弄清楚了。**所以 补语 是第一个需要加强的观念。**

...
例如：
1. {% em type="green" %}<em>John Smith</em>{% endem %} <u>{% em type="red" %}died{% endem %}</u></em> in World War Two.
 （约翰·史密斯死于第二次世界大战。）  
2. {% em type="green" %}<em>John Simth</em>{% endem %} <u>{% em type="red" %}killed{% endem %}</u></em> three enemy soldiers.
（约翰·史密斯杀了三名敌军士兵。）

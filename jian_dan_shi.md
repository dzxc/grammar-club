...
**简单式的动词可以清楚交代此动作是发生于哪个时段**。<b>而与它搭配的时间副词通常会明确标示出一个时段。</b>也就是说：<b>**简单式的时间是括弧的形状**，我们可以**用括弧把简单式的时间括起来**</b>。在以下的叙述中，我们就以括弧来表示简单式中所描述的时间，这个括弧大小不拘，可以小到一个点，也可以大到无限，可是必须标示得很明确。现在来看看几个例子，请注意观察动词时态与时间副词之间的关系：
...
---- 
>  
The U.S. established diplomatic relations with the P.R.C.in 1979.  （美国与中华人民共和国于1979 年建交。）  
